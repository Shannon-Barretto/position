...
class TestRoundTripXOMPosition(unittest.TestCase):
    """ 
    Test a round-trip trade in Exxon Mobil where the initial trade is a but/long of
    100 shares of XOM, at a price of $74.78, with $1.00 commission.
    """
    ...
    def test_calculate_round_trip(self):
        """ 
        After the subsequent purchases, carry out two more buys/longs and then close the
        position out with two additional sells/shorts

        The following prices have been tested against those calculated via
        ...
        self.assertEqual(self.position.total_comission, Decimal("5.50"))
...
class TestRoundTripPGPPosition(unittest.TestCase):
    """ 
    Test a round-trip trade in Proctor & Gamble where the initial trade is a sell/short
    of 100 shares of PG, at a price of $77.69, with $1.00 commission 
    """
    def setUp(self):
        self.position = Position(
            "SLD", "PG", Decimal("100"),
    ...
    def test_calculate_round_trip(self):
        """ 
        After the subsequant sale, carry out two more sells/shorts and then close
        the position out with two additional buys/longs.
        ...
        self.assertEqual(self.position.total_comission, Decimal("5.00"))
